...
@section('main_content')
    ...
    <div class="page-breadcrumb d-none d-sm-flex align-items-center mb-3">
        <div class="breadcrumb-title pe-3">Add Notice/Announcement</div>
        <div class="ps-3">
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb mb-0 p-0 align-items-center">
                    ...
                    <li class="breadcrumb-item active" aria-current="page">Add Notice/Announcement</li>
                </ol>
            </nav>
        </div>
    </div>
    ...
    <form class="row g-3 needs-validation" action="{{ route('master.notice-and-announcement.store') }}" method="POST"
        enctype="multipart/form-data">
        @csrf
        <div class="row">
            <div class="col-xl-12 mx-auto"><br>
                <h6 class="mb-0 text-uppercase">Notice/Announcement Information</h6>
                <hr />
                <div class="card">
                    <div class="card-body">
