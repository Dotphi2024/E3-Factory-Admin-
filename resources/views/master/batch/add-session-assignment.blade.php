...
@section('main_content')
    ...
    <div class="page-breadcrumb d-none d-sm-flex align-items-center mb-3">
        <div class="breadcrumb-title pe-3">Add Session Assignment</div>
        <div class="ps-3">
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb mb-0 p-0 align-items-center">
                    ...
                    <li class="breadcrumb-item active" aria-current="page">Add Session Assignment</li>
                </ol>
            </nav>
        </div>
    </div>
    ...
    <form class="row g-3 needs-validation" action="{{ route('master.batches.store-session-assignment', $batch_schedule->id) }}" method="POST"
                            ...
                            <div class="row g-3 needs-validation">
                                <div class="col-md-6">
                                    ...
                                    <input type="text" class="form-control" id="question" value="{{ old('question') }}"
                                        name="question" placeholder="Enter question" required>
                                </div>
                                <div class="col-md-6">
                                    ...
                                    <select name="option_type" id="option_type" class="form-select" required>
                                        ...
                                        <option value="manual">Manual field</option>
                                        <option value="options">Options</option>
                                    </select>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-check form-switch">
                                        <input class="form-check-input" type="checkbox" id="flexSwitchCheckDefault" name="is_file_upload" value="1">
                                    ...
                                    <div id="options-container" class="d-flex flex-wrap w-100">
                                        <div class="option-group d-flex w-100">
                                            <div class="col-md-4 m-2">
                                                ...
                                                <input type="text" class="form-control" value="{{ old('option') }}"
                                                    name="option[]" placeholder="Enter option" required>
                                            </div>
                                            <div class="col-md-4 m-2">
                                                <label for="mark" class="form-label">Mark</label>
                                                <input type="number" class="form-control" value="{{ old('mark') }}"
                                                    name="mark[]" placeholder="Enter mark" required>
                                            </div>
                                            <div class="col-md-4 m-2 d-flex align-items-center">
                                                <button type="button" class="btn btn-primary mt-4 add-option">+</button>
                                            </div>
                                        </div>
                                    </div>
                                </div>
