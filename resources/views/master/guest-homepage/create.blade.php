...
@section('main_content')
    ...
    <div class="page-breadcrumb d-none d-sm-flex align-items-center mb-3">
        <div class="breadcrumb-title pe-3">Add Guest Homepage Content</div>
        <div class="ps-3">
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb mb-0 p-0 align-items-center">
                    ...
                    <li class="breadcrumb-item active" aria-current="page">Add Guest Homepage Content</li>
                </ol>
            </nav>
        </div>
    </div>
    ...
    <form class="row g-3 needs-validation" action="{{ route('master.guest-homepage.store') }}" method="POST"
