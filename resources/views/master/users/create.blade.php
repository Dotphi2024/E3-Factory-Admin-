...
@section('main_content')
    ...
    <form class="row g-3 needs-validation" action="{{ route('master.users.store') }}" method="POST"
                    ...
                    <div class="card-body">
                        <div class="p-4 border rounded">
                            ...
                            <div class="row g-3 needs-validation">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <div class="input-group mb-3">
                                        <input type="password" class="form-control" placeholder="Password" name="password"
                                            id="password" aria-label="Password" aria-describedby="basic-addon2" required>
                                        <span class="input-group-text" style="cursor: pointer" id="show-password">
                                            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                                                id="show-icon" viewBox="0 0 24 24" fill="none" stroke="currentColor"
                                            ...
                                            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                                                style="display: none" id="hide-icon" viewBox="0 0 24 24" fill="none"
                                ...
                                <div class="col-md-6 role-div" style="display: none">
